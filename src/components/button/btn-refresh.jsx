...
const ButtonWrapper = styled.div`
    ...
    border-color: ${props => props.loading == 'true' ? props.color : 'rgba(0, 0, 0, 0.54)'};
    background-color: ${props => props.loading == 'true' ? props.color : 'transparent' };
`
const Logo = styled.div`
    ...
    background-image: ${props => props.loading == 'true'? css`url(${props.after})` : css`url(${props.before})`};
    animation: ${props => props.loading == 'true' ? css`${rotate} 1s linear infinite;` : 'none' }
`
